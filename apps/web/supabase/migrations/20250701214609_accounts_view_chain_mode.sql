...
-- Recreate the view with chainId and chainMode included
...
comment on view "public"."accounts_view" is 'Secure view of accounts table exposing only non-sensitive public fields including tokenSourceAddress, deploySalt, chainId and chainMode';
