...
-- Recreate the view with tokenSourceAddress included
...
comment on view "public"."accounts_view" is 'Secure view of accounts table exposing only non-sensitive public fields including tokenSourceAddress';
