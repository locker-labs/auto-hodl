...
export function MultiChainBalanceCard({ loading, amount }: { loading: boolean; amount: string }) {
  return (
    <Card className='flex items-center justify-start rounded-xl border-2 border-[#fce2d8]'>
      <CardContent className='h-full w-full flex flex-row sm:flex-col items-center md:flex-row gap-8 sm:gap-5'>
        ...
        <div>
          <p className='text-black text-base text-left sm:text-center md:text-left'>Multi Chain Balance (Base)</p>
