export const aavePoolAbi = [
  ...
  },
  {
    ...
    inputs: [{ name: 'id', type: 'uint8', internalType: 'uint8' }],
    outputs: [{ name: '', type: 'uint128', internalType: 'uint128' }],
    stateMutability: 'view',
  },
  {
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: 'liquidationThreshold', type: 'uint16', internalType: 'uint16' },
          { name: 'liquidationBonus', type: 'uint16', internalType: 'uint16' },
          { name: 'priceSource', type: 'address', internalType: 'address' },
          { name: 'label', type: 'string', internalType: 'string' },
        ],
      },
    ],
  ...
  },
  {
    ...
    inputs: [{ name: 'id', type: 'uint16', internalType: 'uint16' }],
    outputs: [{ name: '', type: 'address', internalType: 'address' }],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      { name: 'asset', type: 'address', internalType: 'address' },
      { name: 'rateStrategyAddress', type: 'address', internalType: 'address' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  },
  {
    ...
    inputs: [
      { name: 'flashLoanPremiumTotal', type: 'uint128', internalType: 'uint128' },
      { name: 'flashLoanPremiumToProtocol', type: 'uint128', internalType: 'uint128' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'backer', type: 'address', indexed: true, internalType: 'address' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'amountCovered', type: 'uint256', indexed: false, internalType: 'uint256' },
    ],
    anonymous: false,
  },
  {
    ...
    inputs: [
      ...
      { name: 'amountCreated', type: 'uint256', indexed: false, internalType: 'uint256' },
    ],
    anonymous: false,
  },
  {
  ...
  },
  {
    ...
    name: 'LiquidationCall',
    inputs: [
      { name: 'collateralAsset', type: 'address', indexed: true, internalType: 'address' },
      { name: 'debtAsset', type: 'address', indexed: true, internalType: 'address' },
      { name: 'user', type: 'address', indexed: true, internalType: 'address' },
      { name: 'debtToCover', type: 'uint256', indexed: false, internalType: 'uint256' },
      { name: 'liquidatedCollateralAmount', type: 'uint256', indexed: false, internalType: 'uint256' },
      { name: 'liquidator', type: 'address', indexed: false, internalType: 'address' },
      { name: 'receiveAToken', type: 'bool', indexed: false, internalType: 'bool' },
    ],
    anonymous: false,
  },
  {
  ...
  },
  {
    ...
    inputs: [
      { name: 'reserve', type: 'address', indexed: true, internalType: 'address' },
      { name: 'liquidityRate', type: 'uint256', indexed: false, internalType: 'uint256' },
      { name: 'stableBorrowRate', type: 'uint256', indexed: false, internalType: 'uint256' },
      { name: 'variableBorrowRate', type: 'uint256', indexed: false, internalType: 'uint256' },
      { name: 'liquidityIndex', type: 'uint256', indexed: false, internalType: 'uint256' },
      { name: 'variableBorrowIndex', type: 'uint256', indexed: false, internalType: 'uint256' },
    ],
    anonymous: false,
  },
  {
